...
const Benefits = () => {
    return (
        <div className='container poppins flex flex-col gap-4'>
            ...
            <div>
                <h4 className='text-[#474747] text-3xl font-semibold leading-[48px] tracking-wide'>Exclusive Benefits of Kigali Ceramics</h4>
            </div>
            <div className='flex flow-row justify-between flex-wrap mt-10'>
