...
const Footer = () => {
    return (
        <div className='w-screen bg-[#DB4444] text-white poppins'>
            <div className='container flex md:flex-row flex-col gap-5 md:justify-between py-14'>
                <h1 className='text-xl font-bold leading-[24px] inter cursor-pointer'>Kigali Ceramics</h1>
                <div className='flex flex-col gap-5'>
                    <h5 className='text-xl font-bold'>QUICK LINKS</h5>
                    <p className='font-extralight cursor-pointer'>Legacy & Privacy</p>
                    <p className='font-extralight cursor-pointer'>Contact</p>
                    <p className='font-extralight cursor-pointer'>Customer Service</p>
                    <p className='font-extralight cursor-pointer'>My account</p>
                </div>
                <div className='flex flex-col gap-5'>
                    <h5 className='text-xl font-bold'>QUICK LINKS</h5>
                ...
                <div className='flex flex-col gap-5'>
                    <h5 className='text-xl font-bold'>HELP AND SUPPORT</h5>
                    <p className='font-extralight cursor-pointer'>Support</p>
                    <p className='font-extralight cursor-pointer'>FAQs</p>
                    <p className='font-extralight cursor-pointer'>Community</p>
                    <p className='font-extralight cursor-pointer'>Blog</p>
                </div>
            </div>
            <div><hr className='container' /></div>
            <p className='font-extralight cursor-pointer flex justify-center items-center text-center py-10'>© 2024 Kigali Ceramics. All Rights Reserved.</p>
        </div>
    )
}
